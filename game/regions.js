...
const zones=[
 ...
 {id:'habitat',label:'🏙️ السكان',x:52,y:24,c:'rgba(55,145,225,.42)'},
 {id:'health',label:'🏥 الطب',x:76,y:36,c:'rgba(225,75,95,.40)'},
 {id:'energy',label:'⚡ الطاقة',x:27,y:68,c:'rgba(235,175,45,.42)'},
